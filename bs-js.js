...
var battleArrayLeft, battleArrayRight, fleetLeft, fleetRight,
	rotationPlayers, stopGame, playerOne, playerTwo, judge; 
...
function createPlayers() {
	...
	var countPlayers = 0;
	playerOne = new Player(0, "Владимир", battleArrayLeft);
	playerTwo = new Player(0, "Петя", battleArrayRight);
